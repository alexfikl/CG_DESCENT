...
/*      struct timeval tv ;
        ...
        */
        ...
        /* Parameter values are overwritten using any values stored in the
           ...
           the parameter value.  A new value for grad_tol (default 1.e-6),
           the solution tolerance, can also be specified in the SPC file.
           Note that the parameter names are case sensitive.  See cg_default.c
           for the parameter names, descriptions, and default values. */
...
/*      gettimeofday (&tv, NULL) ;
        ...
        printf ("%10s %6i %7i %7i %7i %5i %16.7e %16.7e %9.3f\n",
