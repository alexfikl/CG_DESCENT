...
/*      gettimeofday (&tv, NULL) ;
        ...
        status = cg_descent (x, CUTEr_nvar, &Stats, &cg_parm, 1.e-6,
                             cg_value, cg_grad, cg_valgrad, NULL, NULL) ;
/*      gettimeofday (&tv, NULL) ;
...
/*      printf ("%10s %6i %7i %7i %7i %7i %7i %5i %16.7e %16.7e %9.3f\n",
            pname, CUTEr_nvar, Stats.iter, Stats.IterSub, Stats.NumSub,
            Stats.nfunc, Stats.ngrad, status, Stats.gnorm, Stats.f, cpu [1]) ;*/
        printf ("%10s %6i %7i %7i %7i %5i %16.7e %16.7e %9.3f\n",
            pname, CUTEr_nvar, Stats.iter,
            Stats.nfunc, Stats.ngrad, status, Stats.gnorm, Stats.f, cpu [1]) ;
